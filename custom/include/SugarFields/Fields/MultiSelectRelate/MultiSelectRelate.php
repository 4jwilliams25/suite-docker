...
class MultiSelectRelate extends SugarFieldBase
{
    ...
    public function getEditViewSmarty($parentFieldArray, $vardef, $displayParams, $tabindex)
    {
        ...
        //form fields into.
        if (
            isset($vardef['module']) && preg_match('/Accounts/si', $vardef['module'])
    ...
    public function importSanitize(
        ...
        if (isset($vardef['id_name'])) {
            ...
            if (
                ...
                if (
                    isset($relatedFieldDef['db_concat_fields'])
